...
public class Listeners extends Utilities implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		String testCaseNameString = result.getMethod().getDescription();		
		try {
			extentTest.get().addScreenCaptureFromPath(screenShot(testCaseNameString), result.getMethod().getDescription());
		} catch (IOException e) {
